 ...
 */
public final class DocumentFieldAnalyzer extends AnalyzerWrapper {

    private FieldNamePrefixer fieldNamePrefixer = new FieldNamePrefixer();

    public static final Analyzer STANDARD_HTML_ANALYZER = StandardHtmlAnalyzer.createAnalyzer();
    public static final StandardAnalyzer STANDARD_ANALYZER = new StandardAnalyzer(GAEQueryTreeVisitor.LUCENE_VERSION);
